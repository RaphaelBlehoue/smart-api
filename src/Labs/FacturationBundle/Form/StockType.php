...
class StockType extends AbstractType
{
    ...
    {
        $builder
            ->add('quantity',null,array('label'=>false, 'attr' =>array('class'=> 'form-control border-teal border-lg text-teal', "placeholder"=>"Quantité entrée",'required'=>'required')))
            ->add('product','entity',array(
                'label' => false,
                'class' => 'Labs\FacturationBundle\Entity\Product',
                'choice_label' => 'reference',
                'expanded' => false,
                'attr' => array('class'=>'select-border-color border-teal border-lg product_ref','style'=>'text-transform: uppercase'),
                'required' => false
            ))
    ...
    {
        return 'labs_facturationbundle_stock';
    }
}
